...
import '../features/presensi/presentation/pages/detail_today_presensi.dart';
import '../features/presensi/presentation/pages/rekap_bulanan.dart';
...
class Routes {
  static Map<String, Widget Function(BuildContext context)> routes = {
    ...
    rekapBulananRoute: (context) => const RekapBulananPage(),
    detailTodayPresensiRoute: (context) => const DetailTodayPresensiPage(),
  };
}
