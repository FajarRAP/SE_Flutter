...
class EditPerwalianV2 extends StatelessWidget {
  const EditPerwalianV2({super.key});

  @override
  Widget build(BuildContext context) {
    SizeConfig().init(context);

    // Calculate the padding based on the keyboard visibility
...
class MyTextField extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return TextField(
      ...
      style: kNunitoRegular.copyWith(
          fontSize: SizeConfig.blockSizeHorizontal! * 3.75, color: kNeutral90),
      maxLines: null,
