...
import 'bimbingan_sudah_ditanggapi.dart';
import 'edit_bimbingan.dart';
import 'tambah_bimbingan.dart';
import 'tanggapi_bimbingan.dart';

class DetailTugasAkhir extends StatefulWidget {
  const DetailTugasAkhir({super.key});

  @override
  State<DetailTugasAkhir> createState() => _DetailTugasAkhirState();
}

class _DetailTugasAkhirState extends State<DetailTugasAkhir> {
  bool showAll = false;
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            Expanded(
                              flex: 2,
                              child: Text(
                                'Penerapan User Centered Design pada Perancangan UI/UX Aplikasi Mobile Portal Dosen UAD',
                                ...
                                onTap: () {
                                  Navigator.push(
                                    ...
                                    PageTransition(
                                      ...
                                      child: dataPerwalian[1] ==
                                              'Fiftin Novyanto S.T., M.T'
                                          ? TanggapiBimbingan()
                                          : SudahTanggapiBimbingan(),
