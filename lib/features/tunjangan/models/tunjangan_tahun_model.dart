...
TunjanganTahun tunjanganTahunFromJson(String str) => TunjanganTahun.fromJson(json.decode(str));

String tunjanganTahunToJson(TunjanganTahun data) => json.encode(data.toJson());

class TunjanganTahun {
    bool status;
    ...
    factory TunjanganTahun.fromJson(Map<String, dynamic> json) => TunjanganTahun(
        status: json["status"],
