...
class _DetailInformasiGajiState extends State<DetailInformasiGaji> {
  ...
  Widget build(BuildContext context) {
    //ini digunakan untuk mengisi data yang berada pada container berwarna biru
    //sehingga tidak perlu get data
    //data ini didapat dari page sebelumnya
    ...
    return Scaffold(
      ...
      body: RefreshIndicator(
        ...
        backgroundColor: kWhite,
        onRefresh: ()async {
          detailGajiBloc.add(GetGajiEvent());
        },
        child: ListView(
          children: [
            Column(
