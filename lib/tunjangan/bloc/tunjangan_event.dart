...
class GetTunjanganEvent extends TunjanganEvent{} // event untuk mendapatkan seluruh tunjangan

class GetDetailTunjanganEvent extends TunjanganEvent{}  //event untuk mendapatkan detail dari tunjangan yang di klik
